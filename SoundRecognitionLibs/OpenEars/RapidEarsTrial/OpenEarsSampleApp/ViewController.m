...
//    [self.pocketsphinxController startListeningWithLanguageModelAtPath:self.pathToGrammarToStartAppWith dictionaryAtPath:self.pathToDictionaryToStartAppWith acousticModelAtPath:[AcousticModel pathToModel:@"AcousticModelEnglish"] languageModelIsJSGF:FALSE]; // Change "AcousticModelEnglish" to "AcousticModelSpanish" in order to perform Spanish recognition instead of English.
    ...
    [self.pocketsphinxController startRealtimeListeningWithLanguageModelAtPath:self.pathToGrammarToStartAppWith dictionaryAtPath:self.pathToDictionaryToStartAppWith acousticModelAtPath:[AcousticModel pathToModel:@"AcousticModelEnglish"]]; // Starts the rapid recognition loop. Change "AcousticModelEnglish" to "AcousticModelSpanish" in order to perform Spanish language recognition.
}
...
- (void) rapidEarsDidReceiveFinishedSpeechHypothesis:(NSString *)hypothesis recognitionScore:(NSString *)recognitionScore {
    ...
    self.heardTextView.text = [NSString stringWithFormat:@"Heard (finished speech): \"%@\"", hypothesis]; // Show it in the status box.
}

- (void) rapidEarsDidDetectBeginningOfSpeech {
    self.statusTextView.text = @"Status: RapidEars did detect beginning of speech.";
    NSLog(@"rapidEarsDidDetectBeginningOfSpeech");
}

- (void) rapidEarsDidDetectEndOfSpeech {
    self.statusTextView.text = @"Status: RapidEars did detect end of speech.";
